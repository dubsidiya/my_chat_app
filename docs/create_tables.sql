-- Полная схема БД для чат-приложения
-- Выполните этот SQL в вашей новой БД
...
-- Связь пользователей и чатов (многие ко многим)
...
COMMENT ON COLUMN chats.is_group IS 'true для групповых чатов, false для личных';
