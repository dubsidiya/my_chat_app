...
#ifndef MY_CHAT_APP_SWIFT_H
#define MY_CHAT_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="my_chat_app",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC11my_chat_app11AppDelegate")
...
SWIFT_CLASS("_TtC11my_chat_app17MainFlutterWindow")
